...
export default function TreeView({ tale, selectedNode, onSelect }: TreeViewProps) {
  return (
                    ...
                    >
                      {interaction.dialogs.map((dialog, di) => (
                        <TreeNode
                          ...
                          depth={4}
                          onClick={() => onSelect({ type: "dialog", chapterIndex: ci, episodeIndex: ei, interactionIndex: ii, dialogIndex: di })}
                        />
                      ))}
                    </TreeNode>
                  ))}
